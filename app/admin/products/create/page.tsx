...
export default async function CreateProductPage() {
    ...
    return (
        <div className="space-y-6">
            <h1 className="text-3xl font-black text-white tracking-tighter uppercase font-heading italic">System Overview <span className="text-zinc-600">/ Add Entry</span></h1>
